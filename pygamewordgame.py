...
point = 0
press_word = ''
llist = ['apple','ball','cat','dog','egg','fish','girl','horse','ice','jokor','kite','lion','monkey','nest','orange','parrot','queen','rat','sun','tree','umbrella','van','watch','xray','yak','zebra']
...
channel01= pygame.mixer.Channel(1)
channel01.set_volume(0.3)
pygame.mixer.music.set_volume(0.1)
pygame.mixer.music.play()
blastmusic = pygame.mixer.Sound('boom.wav')
lostmusic = pygame.mixer.Sound('loss1 (1).wav')
...
while True:
    ...
    if(word_y < y-5):
        ...
        if bb == 1:
            ...
            channel01.play(lostmusic,maxtime=6000)
